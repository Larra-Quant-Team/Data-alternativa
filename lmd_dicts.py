# -*- coding: utf-8 -*-
"""
Created on Wed Feb  3 11:47:23 2021

@author: ASUS
"""
from itertools import permutations

def get_sentiment_dicts():
    ...
    def_dict = {'Negative': list(set(lmdict['Negative']).union(set(hdict['Negative']))),
                'Positive': list(set(lmdict['Positive']).union(set(hdict['Positive'])))
                }

    del hdict, lmdict

    negate_dict = ["aint", "arent", "cannot", "cant", "couldnt", "darent", "didnt", "doesnt", "ain't", "aren't", "can't",
                   "couldn't", "daren't", "didn't", "doesn't", "dont", "hadnt", "hasnt", "havent", "isnt", "mustnt",
                   "neither", "don't", "hadn't", "hasn't", "haven't", "isn't", "mightn't", "mustn't", "neednt", "needn't",
                   "never", "none", "nope", "nor", "not", "nothing", "nowhere", "oughtnt", "shant", "shouldnt", "wasnt",
                   "werent", "shouldn't", "wasn't", "weren't", "without", "wont", "wouldnt", "won't",
                   "wouldn't", "rarely", "despite", "no", "nobody"]

    return def_dict, negate_dict